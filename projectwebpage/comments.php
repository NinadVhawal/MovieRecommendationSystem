...
if(isset($_GET['title'])) {
    ...
    $rating = RatingDAO::getAverageRating($movieTitle);
    $reviews = RatingDAO::getReviews($movieTitle);
}
...
<body>
    ...
    <div class= "main-movie-info"> 
        ...
        <div class="movie-info">
            ...
            <h4> <b>Ratings</b>: <?php echo number_format($rating->getRating(),2); ?></h4>
            ...
            <div class="row " style="margin-top: 50px">
                <div class="col-md-6 col-md-offset-3 form-container" style="margin:0;width:100%;">
                    ...
                    <?php foreach($reviews as $review) {
                        echo '<div class="row">';
                        echo '    <div style="margin-bottom:5px;" class="col-sm-12 form-group">';
                        echo '        <h4 style="margin-bottom:0px;"> <span style="color:#1a9edb">'.$review->getEmail().'</span> says: </h4>';
                        echo '    </div>';    
                        echo '</div>';
                        echo '<div class="row">';
                        echo '    <div style="margin-bottom:10px;" class="col-sm-12 form-group">';
                        echo '        <h5 style="margin-top:0px;"> '.$review->getReview().' </h5>';
                        echo '    </div>';                      
                        echo '</div>';
                    }
                    ?>
